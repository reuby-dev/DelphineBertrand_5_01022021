function displayCards(cards) {
    cards.forEach(teddy => { 
        ...
        productLink.setAttribute('href', 'produit.html?id=' + teddy._id); //crée des attributs au lien
        ...
        price.innerText = divide(teddy.price) + ' €'; //sélectionne le prix dynamiquement et ajoute la devise
